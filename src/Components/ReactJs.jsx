...
const ReactJs = () => {
  return (
    <section className='flex flex-col items-center gap-y-12 2xl:gap-y-20 justify-center min-h-screen py-10 px-5 tracking-widest pt-20 sm:pt-32 bg-repeat' style={{ backgroundImage: `url(${bgImage})` }}>
