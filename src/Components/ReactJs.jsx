...
const ReactJs = () => {
  return (
    ...
    <h1 className='font-medium text-2xl md:text-3xl 2xl:text-4xl mb-2 text-white uppercase pt-10 sm:pt-0'>react <span className='text-rootColor'>Projects</span></h1>
