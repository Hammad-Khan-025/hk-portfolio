...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col justify-center text-white items-center md:items-start w-64 md:w-auto mb-8 md:mb-0">
        <h3 className="text-orange-500 font-semibold text-2xl 2xl:text-4xl mb-2 tracking-wider">About Me</h3>
    ...
    <div
        ...
        <div className="border-b-2 border-b-orange-500 w-36 2xl:w-40 my-2"></div>
    ...
    <div className="text-white flex flex-col items-center md:items-start text-center w-64 md:w-auto mb-5 md:mb-0 ">
        ...
        <div className="border-b-2 border-b-orange-500 w-36 2xl:w-40 my-2"></div>
        <div className="text-orange-500 text-2xl flex gap-3 md:gap-5 mt-2 reveal-bottom">
